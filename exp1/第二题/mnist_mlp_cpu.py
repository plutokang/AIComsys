...
class MNIST_MLP(object):
    def __init__(self, batch_size=10000, input_size=784, hidden1=64, hidden2=32, hidden3=16,out_classes=10, lr=0.01, max_epoch=1, print_iter=10):
